...
function {:opaque} smc_enter_premium(pageDbIn: PageDb, dispPage: PageNr, arg1: int, arg2: int, arg3: int)
    : (PageDb, int)
    requires validPageDb(pageDbIn) 
    ensures  var db:= smc_neter_premium(pageDbIn, dispPage, arg1, arg2, arg3).0;
        var err := smc_neter_premium(pageDbIn, dispPage, arg1, arg2, arg3).1;
        validPageDb(db) && (err == KEV_ERR_SUCCESS() ==> ValidDispPage(dispPage))
{
