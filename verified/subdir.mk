...
# Spartan (in)direct verification, including cheesy workaround for broken error code.
%.verified %.log: %.gen.dfy %.sdfy 
...
sha256-refined_dep-dfy = ARMspartan ARMprint words_and_bytes.s kom_common.s ARMunroll.i sha/sha256.i sha/bit-vector-lemmas.i sha/sha256-refined-helpers.i sha/sha256-refined-invariants.i
