...
{
    kev_multival_t ret;
    ret.raw = invoke_smc(KEV_SMC_QUERY,0,0,0,0);
    return ret.x.err;
}
...
{
    kev_multival_t ret;
    ret.raw = invoke_smc(KEV_SMC_GETPHYSPAGES,0,0,0,0);
    BUG_ON(ret.x.err != KEV_ERR_SUCCESS);
    return ret.x.val;
}
...
{
    kev_multival_t ret;
    ret.raw = invoke_smc(KEV_SMC_INIT_ADDRSPACE, addrspace_page, l1pt_page, 0, 0);
    return ret.x.err;
}
...
{
    kev_multival_t ret;
    ret.raw = invoke_smc(KEV_SMC_INIT_DISPATCHER, page, addrspace, entrypoint, 0);
    return ret.x.err;
}
...
{
    kev_multival_t ret;
    ret.raw = invoke_smc(KEV_SMC_INIT_L2PTABLE, page, addrspace, l1_index, 0);
    return ret.x.err;
}
...
{
    kev_multival_t ret;
    ret.raw = invoke_smc(KEV_SMC_MAP_SECURE, page, addrspace, mapping, phys_pageno);
    return ret.x.err;
}
...
{
    kev_multival_t ret;
    ret.raw = invoke_smc(KEV_SMC_MAP_INSECURE, addrspace, phys_pageno, mapping, 0);
    return ret.x.err;
}
...
{
    kev_multival_t ret;
    ret.raw = invoke_smc(KEV_SMC_REMOVE, page, 0, 0, 0);
    return ret.x.err;
}
...
{
    kev_multival_t ret;
    ret.raw = invoke_smc(KEV_SMC_FINALISE, addrspace, 0, 0, 0);
    return ret.x.err;
}
...
{
    kev_multival_t ret;
    ret.raw = invoke_smc(KEV_SMC_STOP, addrspace, 0, 0, 0);
    return ret.x.err;
}
...
{
    kev_multival_t ret;
    ret.raw = invoke_smc(KEV_SMC_ENTER, dispatcher, arg1, arg2, arg3);
    while (ret.x.err == KEV_ERR_INTERRUPTED) {
        ret.raw = invoke_smc(KEV_SMC_RESUME, dispatcher, 0, 0, 0);
    }
